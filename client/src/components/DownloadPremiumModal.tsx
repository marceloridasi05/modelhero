...
interface DownloadPremiumModalProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

export default function DownloadPremiumModal({ open, onOpenChange }: DownloadPremiumModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md" data-testid="download-premium-modal">
        <DialogHeader className="text-center space-y-4">
          <div className="mx-auto flex items-center justify-center">
            <img 
              ...
              data-testid="img-download-premium-logo"
            />
          </div>
          <DialogTitle className="text-xl" data-testid="text-download-premium-title">
            {t('common.downloadPremium.title')}
          </DialogTitle>
          <DialogDescription className="text-base" data-testid="text-download-premium-description">
            {t('common.downloadPremium.message')}
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="py-4 space-y-4">
          ...
          <div className="text-center space-y-1">
            <p className="text-xs font-medium text-secondary" data-testid="text-download-premium-promo-label">
              {t(labelKey)}
            </p>
            <p className="text-2xl font-bold text-secondary" data-testid="text-download-premium-price">
              {originalPrice && (
        ...
        <DialogFooter className="flex-col gap-2 sm:flex-col">
          {useStripeCheckout ? (
            <Button 
              ...
              disabled={isLoading}
              data-testid="button-unlock-download"
            >
              {isLoading ? (
          ...
          <Button 
            ...
            data-testid="button-close-download-premium"
          >
